...
public class facultyDropDown_GUI {
	 ...
	 */
	public facultyDropDown_GUI(final int ind) {
		initialize(ind);
	}
	...
	private void initialize(final int ind) {
		...
		comboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				displayFaculty_GUI obj= new displayFaculty_GUI(Run.vec.elementAt(ind).course_fac.elementAt(i));
